...
namespace Kalles.WebUI.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public HomeController(KallesDbContext db, CryptoService crypto, EmailService emailService/*,IMediator mediator*/)
        {
            this.db = db;
            this.crypto = crypto;
        ...
        //[AllowAnonymous]
        //[HttpGet]
        //public async Task<IActionResult> Index(ProductReleatedQuery query)
        //{
        //    var response = await mediator.Send(query);

        //    if (Request.IsAjaxRequest())
        //    {
        //        return PartialView("_Products2", response);
        //    }
